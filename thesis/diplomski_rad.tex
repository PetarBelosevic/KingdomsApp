...
\title{Mobile application for analysis of the state of Kingdoms board game}

% Naslov na hrvatskom jeziku / Title in Croatian
\naslov{Mobilna aplikacija za analizu stanja igre u društvenoj igri Kraljevstva}
...
\begin{izjavaoui}
	...
	Tijekom izrade ovog diplomskog rada korišteni su alati temeljeni na umjetnoj inteligenciji, uključujući ChatGPT, Claude te GitHub Copilot integriran u razvojno okruženje Visual Studio Code. Njihova primjena bila je ograničena na pomoć pri razradi ideja, raspravi o mogućim algoritamskim pristupima, organizaciji programskog rješenja i strukture rada te kao pomoć pri razumijevanju pojedinih algoritama, biblioteka i programskih koncepata korištenih tijekom razvoja sustava.
	
	Prilikom razvoja programskog rješenja alati umjetne inteligencije korišteni su za predlaganje pojedinih dijelova izvornog koda, pomoć pri otklanjanju programskih pogrešaka te raspravu o mogućim implementacijskim rješenjima. Sav predloženi kod detaljno je pregledan, provjeren i prema potrebi izmijenjen prije uključivanja u konačno rješenje. Konačnu arhitekturu sustava, implementaciju, prilagodbe i odluke o dizajnu donio je autor rada.
	
	Alati umjetne inteligencije također su korišteni kao pomoć pri jezičnom oblikovanju pojedinih dijelova teksta, uključujući ispravljanje gramatike i stila te izradu početnih verzija manjih formalnih dijelova rada, poput sažetka, zaključka i ove izjave. Ostali dijelovi diplomskog rada napisani su samostalno, dok su svi tekstovi nastali uz pomoć umjetne inteligencije pregledani, uređeni i prilagođeni od strane autora kako bi odgovarali stvarnom sadržaju rada i vlastitim zaključcima.
	
	Ovime potvrđujem da sam tijekom izrade ovog diplomskog rada koristio umjetnu inteligenciju u skladu s Politikom primjerenog korištenja umjetne inteligencije na Fakultetu elektrotehnike i računarstva, te da umjetna inteligencija nije zamijenila moje kritičko razmišljanje niti moj doprinos.


	% Ako ste koristili umjetnu inteligenciju prilikom izrade svog rada, na ovom mjestu navedite korištene tehnologije, njihove verzije i svrhu korištenja.
	
	% \paragraph{Osvrt na korištenje umjetne inteligencije:}
	% Ukratko opišite opseg vlastitih intervencija i dorada generiranog sadržaja te, ako je primjenjivo, navedite procjenu točnosti, uočena ograničenja ili halucinacije korištene umjetne inteligencije.
...
\label{appendix:dataset_and_model_framework}
	...
	\section{Rad sa skupom podataka za učenje}
