...
config = load_configuration(CONF_FILE_PATH_TEMPLATE.format(model_name="card_castle_model")) # TODO path argument?
...
# Load model
run_num = 15 # get_next_run_num(model_name)-1
epoch = 98 # config["epochs"]-1 # !
